/**
 * Created by tajahmed on 29/06/17.
 */

var app = window.app;
app.controller('ProductSearchController', function($scope,$rootScope,$state,$stateParams, $auth,httpService,storageService,$timeout) {
