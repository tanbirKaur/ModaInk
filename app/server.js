...
app.configure(function(){ 
  ...
  app.use(require('prerender-node').set('prerenderToken', 'LWRaw9u7sFk7m13Lpak8').set('protocol', 'http').set('prerenderServerRequestOptions', {ignoreTimeout: true, retries: 3}));
